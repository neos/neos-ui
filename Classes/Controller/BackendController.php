...
class BackendController extends ActionController
{
    ...
    public function indexAction(string $node = null)
    {
        ...
        try {
            $workspace = $this->workspaceProvider->provideForCurrentAccount($contentRepository->id);
        } catch (WorkspaceDoesNotExist) {
            $this->redirectToUri($this->uriBuilder->uriFor(actionName: 'index', controllerName: 'Login', packageKey: 'Neos.Neos'));
        }
