...
#[Flow\Proxy(false)]
final class TsPropertySchema implements TsRenderableInterface
{
    public function __construct(
        public readonly string $propertyName,
        public readonly TsRenderableInterface $propertyTypeSchema
    ) {
    }

    public function render(string $indent ='', bool $trimFirstLine = false): string
    {
        return ($trimFirstLine ? '' : $indent) . $this->propertyName . ': ' . $this->propertyTypeSchema->render($indent, true);
    }
}
