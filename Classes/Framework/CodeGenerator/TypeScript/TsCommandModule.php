...
#[Flow\Proxy(false)]
final class TsCommandModule implements TsModuleInterface, TsRenderableInterface
{
    public function __construct(
        public readonly TsModulePath $path,
        public readonly string $methodName,
        public readonly TsDtoModule $commandDto
    ) {
    }
    ...
    {
        return $this->commandDto->dependencies;
    }
    ...
    public function render(string $indent = '', bool $trimFirstLine = false): string
    {
        ...
        $lines[] = $indent . 'import { createCommand } from "@neos-project/framework-api";';
        $lines[] = '';
        ...
        $lines[] = $this->commandDto->renderTypeAlias('COMMAND_TYPE', $indent, $trimFirstLine);
        $lines[] = '';

        $lines[] = $indent . 'export const ' . $this->methodName . ' = createCommand(';
        $lines[] = $indent . '    COMMAND_TYPE,';
        $lines[] = $this->commandDto->renderSchema('COMMAND_TYPE', $indent . '    ', false);
        $lines[] = $indent . ');';
        $lines[] = '';
