...
final class GetChildrenForTreeNodeQueryHandler
{
    ...
    {
        $allowedNodeTypesFilter = $nodeTypeService->createNodeTypeFilterFromNodeTypeNames(
        ...
        foreach ($nodeService->findChildNodes($node, $nodeTypeCriteria) as $childNode) {
            ...
            $items[] = $nodeService->createTreeNodeBuilderForNode($childNode)
                ...
                // TODO find generalised name for "isLinkable"
                ->setIsLinkable($allowedNodeTypesFilter->isSatisfiedByNode($childNode))
