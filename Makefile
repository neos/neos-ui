...
test-e2e:
	...
	mv DistributionPackages/Neos.Test DummyTestPackage

	for fixture in Packages/Application/Neos.Neos.Ui/Tests/IntegrationTests/Fixtures/*/; do
		echo "$fixture"

		cp -r "Packages/Application/Neos.Neos.Ui/Tests/IntegrationTests/Fixtures/${fixture}/SitePackage" DistributionPackages/Neos.Test

		FLOW_CONTEXT=Production ./flow site:prune
		FLOW_CONTEXT=Production ./flow site:import --package-key=Neos.Test
		...
		rm -rf DistributionPackages/Neos.Test

	done

	mv DummyTestPackage DistributionPackages/Neos.Test
