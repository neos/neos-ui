...
We have created a little distribution to make it easier to use the acceptance tests.
You just need to follow the install instructions and put the right branch into Neos.Neos.Ui
folder and run webserver.
