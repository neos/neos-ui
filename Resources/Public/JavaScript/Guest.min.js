...
var _reductComponent2 = _interopRequireDefault(_reductComponent);

var _reductNitpick = require('@reduct/nitpick');

var _reductNitpick2 = _interopRequireDefault(_reductNitpick);

var propTypes = {
    'accessId': _reductNitpick2['default'].isString.isRequired
};

var ContentComponent = (function (_Component) {
    _inherits(ContentComponent, _Component);

    function ContentComponent(el) {
        _classCallCheck(this, ContentComponent);

        _get(Object.getPrototypeOf(ContentComponent.prototype), 'constructor', this).call(this, el, {
            props: {
    ...
    _createClass(ContentComponent, [{
        key: 'injectNeosBackendService',
        value: function injectNeosBackendService(neosBackendService) {
        ...
        key: 'commitChange',
        value: function commitChange(property, value) {
            this.neosBackendService.documentManager.commitChange(window.name, {
                childNodes: _defineProperty({}, this.getProp('accessId'), {
                    properties: _defineProperty({}, property, value)
                })
            });
        }
    }, {
        ...
        value: function getProperty(property) {
            return this.neosBackendService.documentManager.getConfiguration(window.name).childNodes[this.getProp('accessId')].properties[property];
        }
    }]);

    return ContentComponent;
})(_reductComponent2['default']);

exports['default'] = ContentComponent;
module.exports = exports['default'];

},{"@reduct/component":8,"@reduct/nitpick":9}],2:[function(require,module,exports){
'use strict';
...
var AbstractEditor = (function (_Component) {
    _inherits(AbstractEditor, _Component);

    function AbstractEditor(el, owner, property) {
        var options = arguments.length <= 3 || arguments[3] === undefined ? {} : arguments[3];

        _classCallCheck(this, AbstractEditor);

        _get(Object.getPrototypeOf(AbstractEditor.prototype), 'constructor', this).call(this, el, options);
    ...
    _createClass(AbstractEditor, [{
        ...
        value: function initializeEvents() {
            ...
            this.el.addEventListener('click', function () {
                return _this.commenceThaw();
            });
        }
    }, {
        key: 'commenceThaw',
        value: function commenceThaw() {
            var _this2 = this;
            ...
            if (this.owner.isActive()) {
                ...
                setTimeout(function () {
                    document.addEventListener('keydown', _this2.handleKeyStroke);
                    document.addEventListener('click', _this2.handleOutsideClick);
                    _this2.editorDidMount();
                }, 0);
            }
        }
    }, {
        ...
        value: function handleOutsideClick(e) {
            ...
            setTimeout(function () {
                if (!check(e.target)) {
                    _this3.commenceCommit();
                }
            }, 0);
        }
    }, {
        key: 'commenceCommit',
        value: function commenceCommit() {
        ...
        key: 'commenceAbort',
        value: function commenceAbort() {
            this.commenceFreeze();
        }
    }, {
        key: 'commenceFreeze',
        value: function commenceFreeze() {
            var el = this.freeze(this.__storedElement);
...
exports['default'] = AbstractEditor;
module.exports = exports['default'];

},{"@reduct/component":8}],3:[function(require,module,exports){
'use strict';
...
var _AbstractEditor2 = require('./AbstractEditor');

var _AbstractEditor3 = _interopRequireDefault(_AbstractEditor2);

var Oneline = (function (_AbstractEditor) {
    _inherits(Oneline, _AbstractEditor);

    function Oneline() {
        _classCallCheck(this, Oneline);

        _get(Object.getPrototypeOf(Oneline.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(Oneline, [{
        key: 'thaw',
        value: function thaw(el, value) {
    ...
    return Oneline;
})(_AbstractEditor3['default']);

exports['default'] = Oneline;
module.exports = exports['default'];

},{"./AbstractEditor":2}],4:[function(require,module,exports){
'use strict';
...
var Oneline = (function (_AbstractEditor) {
    ...
    _createClass(Oneline, [{
        ...
        key: 'editorDidMount',
        value: function editorDidMount() {
            this.editor = new _mediumEditor2['default'](this.el, {
                toolbar: {
...
},{"./AbstractEditor":2,"medium-editor":11}],5:[function(require,module,exports){
'use strict';
...
var _ComponentsContentComponent = require('../Components/ContentComponent');

var _ComponentsContentComponent2 = _interopRequireDefault(_ComponentsContentComponent);

var _ComponentsEditorsOneline = require('../Components/Editors/Oneline');

var _ComponentsEditorsOneline2 = _interopRequireDefault(_ComponentsEditorsOneline);

var _ComponentsEditorsRichText = require('../Components/Editors/RichText');

var _ComponentsEditorsRichText2 = _interopRequireDefault(_ComponentsEditorsRichText);

var DOMConnector = (function () {
    function DOMConnector(NeosBackend) {
        _classCallCheck(this, DOMConnector);

        this.contentComponents = [];
        this.neosBackend = NeosBackend;
    }

    _createClass(DOMConnector, [{
        key: 'run',
        value: function run() {
            var _this = this;

            [].slice.call(document.querySelectorAll('[data-__neos-access-id]')).forEach(function (contentElement) {
                var accessId = contentElement.dataset.__neosAccessId;
                var contentComponent = new _ComponentsContentComponent2['default'](contentElement);

                contentComponent.injectNeosBackendService(_this.neosBackend);

                _this.contentComponents.push(contentComponent);

                if (contentElement.dataset.__neosEditor) {
                    if (contentElement.dataset.__neosEditor === 'Oneline') new _ComponentsEditorsOneline2['default'](contentElement, contentComponent, contentElement.dataset.__neosProperty);

                    if (contentElement.dataset.__neosEditor === 'RichText') new _ComponentsEditorsRichText2['default'](contentElement, contentComponent, contentElement.dataset.__neosProperty);
                }
...
exports['default'] = function (NeosBackend, DocumentData) {
    return new DOMConnector(NeosBackend, DocumentData);
};

module.exports = exports['default'];

},{"../Components/ContentComponent":1,"../Components/Editors/Oneline":3,"../Components/Editors/RichText":4}],6:[function(require,module,exports){
'use strict';
...
var _ServiceNeosBackend = require('./Service/NeosBackend');

var _ServiceNeosBackend2 = _interopRequireDefault(_ServiceNeosBackend);

var _ProcessDOMConnector = require('./Process/DOMConnector');

var _ProcessDOMConnector2 = _interopRequireDefault(_ProcessDOMConnector);

var NeosBackendService = (0, _ServiceNeosBackend2['default'])(window.parent);

NeosBackendService.documentManager.addConfiguration(window.name, window['@Neos:DocumentData']);

var DocumentData = NeosBackendService.documentManager.getConfiguration(window.name);
var DOMConnector = (0, _ProcessDOMConnector2['default'])(NeosBackendService, DocumentData);

DOMConnector.run();

},{"./Process/DOMConnector":5,"./Service/NeosBackend":6}],8:[function(require,module,exports){
(function (global){
...
},{"./messages.js":3,"@reduct/logger":1}],3:[function(_dereq_,module,exports){
'use strict';
