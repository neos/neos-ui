Feature: GetChildrenForTreeNode
  ...
  Background:
    ...
    And the following CreateNodeAggregateWithNode commands are executed:
      ...
      | referenceable             | homepage              | Vendor.Site:Document                 | {"title": "referenceable"} | {"language": "en"}        |          |
  ...
  Scenario: GetChildrenForTreeNode for homepage with nested children
    When I issue the following query to "http://127.0.0.1:8081/neos/references-editor/get-children-for-tree-node":
      | Key                 | Value                |
