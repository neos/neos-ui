...
import {createUserFactory} from "../helpers/test-api";
...
Given(
    ...
    async ({request, $testInfo}, username: string, password: string, role: string) => {
        const createUser = createUserFactory(request, $testInfo);
