...
const NOTIFICATION_TYPE = 
    "Neos\\Neos\\Ui\\Application\\Notification\\PropertiesWereUpdatedNotification";

export const PropertiesWereUpdatedNotification = createNotification(
    NOTIFICATION_TYPE,
    s.object({
        __type: s.literal(NOTIFICATION_TYPE),
        nodeContextPath: s.string(),
        reloadRequired: s.boolean(),
