        ...
        return (
            <div className={style.root}>
                ...
                <ButtonGroup value={mode} onSelect={this.handleSelect} className={style.buttonGroup}>
                    ...
                    >
                        <Icon icon="resource://Neos.Neos:Ui/Public/Icons/create-above.svg" size="1x"/>
                    ...
                    >
                        <Icon icon="resource://Neos.Neos:Ui/Public/Icons/create-below.svg" size="1x"/>
                    ...
                    >
                        <Icon icon="resource://Neos.Neos:Ui/Public/Icons/create-inside.svg" size="1x"/>
