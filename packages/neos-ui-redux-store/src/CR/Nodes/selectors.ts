...
import {ClipboardMode} from '@neos-project/neos-ts-interfaces';
import {NodeContextPath, NodeMap, Node, NodeTypeName} from '@neos-project/neos-ui-contentrepository-model';
