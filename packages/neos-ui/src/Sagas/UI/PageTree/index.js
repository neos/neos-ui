...
export function * watchToggle({globalRegistry}) {
    ...
    yield takeLatest(actionTypes.UI.PageTree.TOGGLE, function * (action) {
...
export function * watchRequestChildrenForContextPath({configuration}) {
    yield takeEvery(actionTypes.UI.PageTree.REQUEST_CHILDREN, function * (action) {
...
export function * watchCurrentDocument({configuration}) {
    yield takeLatest(actionTypes.UI.ContentCanvas.SET_CONTEXT_PATH, function * (action) {
        const {contextPath} = action.payload;
...
export function * watchSearch({configuration}) {
    yield takeLatest(actionTypes.UI.PageTree.COMMENCE_SEARCH, function * (action) {
