...
exports.config = {
    ...
    before() {
        var defaultConfig = readYaml('Build/TestSuite.Settings.yaml.example');
        var config = Object.assign(defaultConfig, readYaml('Build/TestSuite.Settings.yaml')).WebdriverIO;
